...
class hash_deepnet_fixed_embedding(object):
    def __init__(self):
...
if __name__ == "__main__":
    model = hash_deepnet_fixed_embedding()
    ...
    np.save("/home/huangzhengjie/quora_pair/quora_stack/stage1_output/train/hash_deepnet_fixed_embedding_%s.npy" % state, X_prediction)
    model.train_all()
    pred = model.test()
    np.save("/home/huangzhengjie/quora_pair/quora_stack/stage1_output/test/hash_deepnet_fixed_embedding_%s.npy" % state, pred)
