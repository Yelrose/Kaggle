...
feature = Merge(mode='concat', concat_axis=-1)([abs_feature, mul_feature, gru_abs_feature, gru_mul_feature, leaks_dense])
...
# train data
X_q1 = np.load("/home/huangzhengjie/quora_pair/quora_stack/stage0_output/train/X_q1_sc.npy", mmap_mode='r')
X_q2 = np.load("/home/huangzhengjie/quora_pair/quora_stack/stage0_output/train/X_q2_sc.npy", mmap_mode='r')
...
class hash_deepnet_sc(object):
    ...
    def test(self):
        test_q1 = np.load('/home/huangzhengjie/quora_pair/quora_stack/stage0_output/test/X_q1_sc.npy')[:,:max_sequence_length]
        test_q2 = np.load('/home/huangzhengjie/quora_pair/quora_stack/stage0_output/test/X_q2_sc.npy')[:,:max_sequence_length]
...
if __name__ == "__main__":
    ...
    np.save("/home/huangzhengjie/quora_pair/quora_stack/stage1_output/train/hash_deepnet_sc_%s.npy" % state, X_prediction)
    model.train_all()
    pred = model.test()
    np.save("/home/huangzhengjie/quora_pair/quora_stack/stage1_output/test/hash_deepnet_sc_%s.npy" % state, pred)
