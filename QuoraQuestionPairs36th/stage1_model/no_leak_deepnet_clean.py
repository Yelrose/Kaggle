...
if __name__ == "__main__":
    ...
    np.save("/home/huangzhengjie/quora_pair/quora_stack/stage1_output/train/no_leak_deepnet_clean_%s.npy" % state, X_prediction)
    model.train_all()
    pred = model.test()
    np.save("/home/huangzhengjie/quora_pair/quora_stack/stage1_output/test/no_leak_deepnet_clean_%s.npy" % state, pred)
