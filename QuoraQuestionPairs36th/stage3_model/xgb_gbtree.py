...
stage1_model = glob.glob('/home/huangzhengjie/quora_pair/quora_stack/hyperopt_output/train/*.npy')
...
for mn in stage1_model:
    ...
    x_mn_test = np.load('/home/huangzhengjie/quora_pair/quora_stack/hyperopt_output/test/' + mn)
...
for fold_id, (train_index, test_index) in enumerate(kfd):
    ...
    bst = xgb.train(params, d_train, 50, watchlist, verbose_eval=5)
...
np.save("/home/huangzhengjie/quora_pair/quora_stack/stage3_output/train/xgb_gbtree_%s.npy" % state, xgb_train_output)
# train all
d_train = xgb.DMatrix(x_train, label=y_train)
watchlist = [(d_train, 'train')]
bst = xgb.train(params, d_train, 50, watchlist, verbose_eval=50)
pred = bst.predict(d_test)
np.save("/home/huangzhengjie/quora_pair/quora_stack/stage3_output/test/xgb_gbtree_%s.npy" % state, pred)
