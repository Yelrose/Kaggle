...
def logging_output(param, train_mat, test_mat, loss, std):
    ...
    np.save('/home/huangzhengjie/quora_pair/quora_stack/hyperopt_output_stage2/train/' + fn +'.npy', train_mat)
    np.save('/home/huangzhengjie/quora_pair/quora_stack/hyperopt_output_stage2/test/' + fn +'.npy', test_mat)
